...
following the calculations in `ven der Lann et al <https://doi.org/10.1002/we.2017>`_ and `Dyer (1974) <https://doi.org/10.1007/BF00240838>`_ formulation  for unstable stratification (:math:`z_b/L < 0`):
